        ...
        <main class="main">
            ...
            <section class="home section" id="home">
                ...
                <div class="home__container container grid">
                    ...
                    <img src="assets/img/home.png" alt="home" class="home__img">
                ...
                <div class="popular__container container swiper">
                    <div class="swiper-wrapper">
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="assets/img/popular1.png" alt="popular" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="assets/img/popular2.png" alt="popular" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="assets/img/popular3.png" alt="popular" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="assets/img/popular4.png" alt="popular" class="popular__img">
                        ...
                        <article class="popular__card swiper-slide">
                            ...
                            <img src="assets/img/popular5.png" alt="popular" class="popular__img">
            ...
            <section class="features section">
                ...
                <div class="features__container container grid">
                    <div class="features__group">
                        <img src="assets/img/features.png" alt="featured" class="features__img">
                ...
                <img src="assets/img/map.svg" alt="features" class="features__map">
            </section>
        ...
        <div class="featured__container container">
            <ul class="featured__filters">
                ...
                while ($row = mysqli_fetch_assoc($result_kategori)) {
                    echo '<li>
                            <button class="featured__item" data-filter=".' . strtolower($row['nama']) . '">
                                <img src="assets/img/' . $row['img'] . '" alt="' . $row['nama'] . '">
                            </button>
                          </li>';
                }
                ?>
            ...
            <div class="featured__content grid">
                <?php
                $query_mobil = "SELECT m.*, k.nama AS kategori FROM mobil m
                                JOIN kategori k ON m.id_kategori = k.id_kategori";
                $result_mobil = mysqli_query($conn, $query_mobil);

                while ($row = mysqli_fetch_assoc($result_mobil)) {
                    echo '<article class="featured__card mix ' . strtolower($row['kategori']) . '">
                            <div class="shape shape__smaller"></div>

                            <h1 class="featured__title">' . $row['kategori'] . '</h1>
                            <h3 class="featured__subtitle">' . $row['subtitle'] . '</h3>
                            <img src="assets/img/' . $row['img'] . '" alt="' . $row['title'] . '" class="featured__img">
                            <h3 class="featured__price">$' . number_format($row['harga'], 2) . '</h3>
            ...
            <section class="offer section">
                <div class="offer__container container grid">
                    <img src="assets/img/offer-bg.png" alt="offer" class="offer__bg">
                    ...
                    <img src="assets/img/offer.png" alt="offer" class="offer__img">
                </div>
            </section>
            ...
            <div class="footer__container container grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">
                        <i class="ri-steering-line"></i> Showroom Mobile
                    </a>
